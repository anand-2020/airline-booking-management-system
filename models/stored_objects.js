...
BEGIN
    ...
    SELECT DEPARTURE_DATE, FARE, STATUS
    INTO DEP_DATE, ORIGINAL_FARE, TSTATUS
    FROM TICKET, FLIGHT_DATE
    WHERE TICKET_ID = TID
    ...
    ELSE
        UPDATE TICKET
        SET STATUS = 'CANCELLED', TIME_OF_CANCELLATION = TOC, REIMBURSED_AMOUNT = CALCULATE_REIMBURSEMENT(ORIGINAL_FARE, DEP_DATE)
        WHERE TICKET_ID = TID;
    END IF;
END $$
